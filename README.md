* **SDO_for_DIT.png and SDO_for_cm.png:** The two figures are the style-guided results generated using Shortcut Diffusion Optimization (SDO) for **PixArt-α** and **Latent Consistency Model**, respectively.
